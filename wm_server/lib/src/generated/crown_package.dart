...
class CrownPackageUpdateTable extends _i1.UpdateTable<CrownPackageTable> {
  CrownPackageUpdateTable(super.table);
  ...
  _i1.ColumnValue<double, double> netProfit(double value) => _i1.ColumnValue(
    table.netProfit,
    value,
  );

  _i1.ColumnValue<double, double> profitToWeMultiply(double value) =>
      _i1.ColumnValue(
        table.profitToWeMultiply,
        value,
      );

  _i1.ColumnValue<double, double> profitToCEO(double value) => _i1.ColumnValue(
    table.profitToCEO,
    value,
  );

  _i1.ColumnValue<double, double> profitToFounders(double value) =>
      _i1.ColumnValue(
        table.profitToFounders,
        value,
      );

  _i1.ColumnValue<double, double> profitToMembers(double value) =>
      _i1.ColumnValue(
        table.profitToMembers,
        value,
      );

  _i1.ColumnValue<double, double> profitToTithes(double value) =>
      _i1.ColumnValue(
        table.profitToTithes,
        value,
      );
}
...
class CrownPackageTable extends _i1.Table<int?> {
  CrownPackageTable({super.tableRelation})
    ...
    updateTable = CrownPackageUpdateTable(this);
  ...
  late final CrownPackageUpdateTable updateTable;
...
class CrownPackageRepository {
  ...
  /// Updates a single [CrownPackage] by its [id] with the specified [columnValues].
  /// Returns the updated row or null if no row with the given id exists.
  Future<CrownPackage?> updateById(
    _i1.Session session,
    int id, {
    required _i1.ColumnValueListBuilder<CrownPackageUpdateTable> columnValues,
    _i1.Transaction? transaction,
  }) async {
    return session.db.updateById<CrownPackage>(
      id,
      columnValues: columnValues(CrownPackage.t.updateTable),
      transaction: transaction,
    );
  }

  /// Updates all [CrownPackage]s matching the [where] expression with the specified [columnValues].
  /// Returns the list of updated rows.
  Future<List<CrownPackage>> updateWhere(
    _i1.Session session, {
    required _i1.ColumnValueListBuilder<CrownPackageUpdateTable> columnValues,
    ...
    return session.db.updateWhere<CrownPackage>(
      columnValues: columnValues(CrownPackage.t.updateTable),
