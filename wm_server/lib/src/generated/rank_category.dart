...
class RankCategoryUpdateTable extends _i1.UpdateTable<RankCategoryTable> {
  RankCategoryUpdateTable(super.table);
...
class RankCategoryTable extends _i1.Table<int?> {
  RankCategoryTable({super.tableRelation}) : super(tableName: 'rank_category') {
    updateTable = RankCategoryUpdateTable(this);
  ...
  late final RankCategoryUpdateTable updateTable;
...
class RankCategoryRepository {
  ...
  /// Updates a single [RankCategory] by its [id] with the specified [columnValues].
  /// Returns the updated row or null if no row with the given id exists.
  Future<RankCategory?> updateById(
    _i1.Session session,
    int id, {
    required _i1.ColumnValueListBuilder<RankCategoryUpdateTable> columnValues,
    _i1.Transaction? transaction,
  }) async {
    return session.db.updateById<RankCategory>(
      id,
      columnValues: columnValues(RankCategory.t.updateTable),
      transaction: transaction,
    );
  }

  /// Updates all [RankCategory]s matching the [where] expression with the specified [columnValues].
  /// Returns the list of updated rows.
  Future<List<RankCategory>> updateWhere(
    _i1.Session session, {
    required _i1.ColumnValueListBuilder<RankCategoryUpdateTable> columnValues,
    ...
    return session.db.updateWhere<RankCategory>(
      columnValues: columnValues(RankCategory.t.updateTable),
