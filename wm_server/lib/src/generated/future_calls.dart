...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'BirthdayReminderSendReminderFutureCall':
          BirthdayReminderSendReminderFutureCall(),
    };
...
class _BirthdayReminderFutureCallDispatcher {
  ...
  Future<void> sendReminder(
    ...
    var object = _i2.BirthdayReminderSendReminderModel(
      message: message,
      author: author,
    );
...
class BirthdayReminderSendReminderFutureCall
    extends _i1.FutureCall<_i2.BirthdayReminderSendReminderModel> {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i2.BirthdayReminderSendReminderModel? object,
  ) async {
    if (object != null) {
      await _i4.BirthdayReminder().sendReminder(
        session,
        object.message,
        object.author,
      );
