...
--
-- Class CartItems as table cart_items
--
...
--
-- Class Packages as table packages
--
...
--
-- Class Products as table products
--
...
--
-- Class SalesItems as table sales_items
--
...
--
-- Foreign relations for "sales" table
--
...
--
-- Foreign relations for "sales_items" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('wm', '20251030083609259', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251030083609259', "timestamp" = now();
